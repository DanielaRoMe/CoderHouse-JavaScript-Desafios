...
let paraTomar =  document.getElementById("paraTomar");
for(const bebida of bebidas){
    let li = document.createElement("li");
    li.innerHTML = `${bebida.nombre}: $${bebida.precio}`;
    paraTomar.append(li);
}
 
let paraComer = document.getElementById("paraComer");
for(const comida of comidas){
    let li = document.createElement("li");
    li.innerHTML = `${comida.nombre}: $${comida.precio}`;
    paraComer.append(li);
}
